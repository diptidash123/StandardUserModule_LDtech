...
function Timesheet() {
  ...
  const Buttons =() => {
    return(
      <div style={{marginLeft:"28rem" , marginTop:"13px"}}>
        ...
        <a href="#" className="btn btn-primary" onClick={Dashboard}>Back</a>
      </div>
    )
  }
  ...
  return (
    <div className="d-flex  justify-content-center align-items-center " style={{backgroundColor:"gainsboro", border:"5px"}}>
      <div className="container">
        <div className="abc" >
          <img src='https://www.ldtech.in/images/logo.png' id="a2" style={{marginTop:"2rem", marginLeft:"1 rem"}} />
        </div>
        ...
        <div className="h-40px" style={{backgroundColor:"gainsboro"}}>
          <div
            style={{
              display: "flex",
              flexDirection: "row",
